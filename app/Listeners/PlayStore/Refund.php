...
class Refund extends PlayStoreListener
{
    /**
     * Notification type: SUBSCRIPTION_REVOKED (12) — kullanıcı iade aldı.
     *
    ...
    public function handle($event): void
    {
        ...
        // Play Store iade anını userCancellationTimeMillis veya şimdiki zaman olarak işaretleriz
